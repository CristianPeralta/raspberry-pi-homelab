---
name: bt-devices
description: Scan for nearby Bluetooth devices (speakers, TVs, headphones, phones). Triggers on /bluetooth or /bt or keywords like "bluetooth", "parlante", "parlantes", "auriculares", "TV bluetooth", "dispositivos bluetooth", "BT", "nearby", "cercanos".
---

# Bluetooth Device Scanner

When the user sends `/bt`, `/bluetooth` or asks about bluetooth devices, IMMEDIATELY execute this and format the output:
