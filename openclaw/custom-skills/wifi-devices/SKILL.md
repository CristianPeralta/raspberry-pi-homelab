---
name: wifi-devices
description: Scan which devices are currently online on the home WiFi network. Triggers on /wifi or keywords like "conectados", "activos", "quien esta", "wifi", "dispositivos activos", "en la red", "online", "quienes estan", "hay alguien".
---

# WiFi Devices Scanner

When the user sends `/wifi` or asks who is connected, IMMEDIATELY execute this and format the output:
